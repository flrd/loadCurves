...
# UNA:+.? '
# UNB+UNOC:3+{{Sender}}:500+{{Receiver}}:500+210917:1500+DCBKCICHBBCECD++TL'
...
# NAD+DP'
# LOC+172+{{MaLo / MeLo}}'
# DTM+163:{{PeriodStart}}?+01:303'
# DTM+164:{{PeriodEnd}}?+01:303'
# LIN+1'
# PIA+5+{{Register}}:SRW'
# QTY+220:{{Value 1}}'
# DTM+163:{{Timestamp 1a}}?+01:303'
# DTM+164:{{Timestamp 1b}}?+01:303'
# QTY+220:{{Value 2}}'
# DTM+163:{{Timestamp 2a}}?+01:303'
# DTM+164:{{Timestamp 2b}}?+01:303'
# QTY+220:{{Value 3}}'
# DTM+163:{{Timestamp 3a}}?+01:303'
# DTM+164:{{Timestamp 3b}}?+01:303'
# UNT+{{Anzahl Messwerte}}+DCBKCICHBBCFBG'
...
msconsOutput <- function(
  ...
  ,register = NULL
  ,timeSeries
  ,quantity# this is the sequence generated by interval()
  ) {
  ...
  # For OBIS-Code, see page 5/27 in: https://www.edi-energy.de/index.php?id=38&tx_bdew_bdew%5Buid%5D=838&tx_bdew_bdew%5Baction%5D=download&tx_bdew_bdew%5Bcontroller%5D=Dokument&cHash=a7a251b9c22a4b3fa581f0717736a8ef
  # example: 1-1:1.29.0
  PIA <- PIAsegment(register)
  
  # if user did not provide input, then add a {{Placeholder}}
  # in the MSCONS message for below listed segments
  ...
  writeLines(
    c(
      ...
      ,valuesMSCONS(
        ...
        quantity = formatC(pi, decimal.mark = ","))
